...
public class Meteor : LivingEntity
{
    ...
    private void Start()
    {
        // Initial direction is towards the player or center if player is dead
        Player player = Game.instance.Player;
        Vector2 dir = (Vector2)((Game.IsValid(player) ? player.transform.position : Game.instance.mainCamera.Center) - position);
        dir.Normalize();
